...
function Signup() {
  ...
  const { signup, loginWithGoogle, user, profile, loading } = useAuthStore();
  ...
  if (successMsg) {
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-[#f0fdf4] via-[#dcfce7] to-[#bbf7d0] dark:from-[#102219] dark:via-[#142f22] dark:to-[#173a2a] transition-colors duration-200">
        <div
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative p-6 py-12 bg-gradient-to-br from-[#f0fdf4] via-[#dcfce7] to-[#bbf7d0] dark:from-[#102219] dark:via-[#142f22] dark:to-[#173a2a] transition-colors duration-200">
      ...
      <div className="w-full max-w-md relative z-10 flex flex-col justify-between py-6">
        
        {/* Back Button - Responsive top flow on mobile, absolute top-8 left-8 on desktop */}
        <Link
          to="/"
        ...
        <div className="bg-white dark:bg-[#1a2e24] border border-[#f0fdf4] dark:border-[#2a4034] rounded-3xl p-6 sm:p-8 shadow-xl dark:shadow-slate-950/40">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-black text-[#0f1f12] dark:text-emerald-400 tracking-tight mb-2 font-syne">Create Account</h2>
            <p className="text-slate-500 dark:text-slate-400 text-sm">Start automating your IT support today</p>
          </div>
                  ...
                  <div className="grid grid-cols-2 gap-x-2 gap-y-0.5 mt-2">
                    {[
                      ...
                      <span key={label} className={`text-[10px] font-semibold flex items-center gap-1 transition-colors ${
                        ok ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-400 dark:text-red-500'
                      }`}>
                        <span>{ok ? '✓' : '○'}</span> {label}
                      </span>
                    ))}
