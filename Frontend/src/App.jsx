...
// Auth Components - Keep these eager for fast initial load
...
// Legacy components - Keep eager for core functionality
...
const TicketProcessing = lazy(() => import("./user/pages/AIProcessing"));
...
// Lazy-loaded Master Admin Components
...
// Protected Route Components - Keep eager
