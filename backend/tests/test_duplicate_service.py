...
def test_picks_best_match_among_multiple(dup_svc, tmp_path):
    ...
    with patch("backend.services.duplicate_service.util.pytorch_cos_sim") as mock_sim:
        mock_sim.return_value = torch.tensor([[0.5, 0.8, 0.95]])
