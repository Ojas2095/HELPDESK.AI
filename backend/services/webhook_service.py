        ...
        "attachments": [
            {
                ...
                "blocks": [
                    ...
                    },
                    {
                        "type": "section",
                        "fields": [
                            {"type": "mrkdwn", "text": f"*Ticket:*\n<{os.environ.get('FRONTEND_BASE_URL', 'https://helpdeskaiv1.vercel.app')}/tickets/{ticket_id}|{ticket_ref}>"},
        ...
        "potentialAction": [
            {
                ...
                "targets": [
                    {
                        "os": "default",
                        "uri": f"{os.environ.get('FRONTEND_BASE_URL', 'https://helpdeskaiv1.vercel.app')}/tickets/{ticket_id}",
                    }
                ],
            }
        ],
